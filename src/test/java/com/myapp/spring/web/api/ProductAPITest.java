...
public class ProductAPITest {
	...
	public void testAddNewProducts() throws Exception {
		...
		Product mockproduct = new Product("mobiles", "Oneplus", "OnePlus9Pro", 70000.00, 4);
...
//		.andExpect(jsonPath("$[2].quantity",is(2.5)));
//	
	...
	public void testGetProductsByName() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/products/user/findByName","Oneplus"))
				// Validate Status should be 200 ok and json response recived
	...
	public void testGetProductsByCategory() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/products/user/findByCategory","mobile"))
				// Validate Status should be 200 ok and json response recived
