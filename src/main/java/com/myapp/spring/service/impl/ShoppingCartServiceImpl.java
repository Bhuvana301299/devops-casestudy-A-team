...
public class ShoppingCartServiceImpl implements ShoppingCartService {
    ...
    public Map<Product, Integer> addProduct(Product product,Integer quantity) {
        ...
        Map<Product, Integer> addedEntity=new HashMap<Product, Integer>();
    ...
    public Map<Product, Integer> removeProduct(Product product,Integer quantity) {
        ...
        Map<Product, Integer> removedEntity=new HashMap<Product, Integer>();
        removedEntity.put(product,quantity);
