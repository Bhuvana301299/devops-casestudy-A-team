...
public class ProductAPI {
	...
	//http://localhost:8080/products/findByPrice/40000	
	...
	//
	//http://localhost:8080/products/findByName?productName=
    ...
    //http://localhost:8080/products/findByCategory?category=
	  ...
	  return new ResponseEntity<List<Product>>(repository.findByCategoryLike(category.orElse("")).get(), HttpStatus.OK); }
}
